...
description: Audit your Claude Code setup against available features and surface what you're not using but should, plus setup gaps. Use to discover underused features and optimize your configuration for your workflow. User-invoked — run /cc-adoption-audit; the agent will not auto-fire it.
